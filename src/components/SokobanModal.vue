<template>
    <div
        ...
        @click="$emit('close-sokoban')"
    >
        <div
            id="modal"
            class="bg-white h-[550px] md:h-[540px] w-10/12 md:w-1/3 mt-20 p-10 rounded-lg"
            @click.stop
        >
            <div id="container" class="flex justify-center flex-col gap-4">
                ...
                <div>
                    ...
                    >
                        <iframe
                            src="https://giphy.com/embed/ufMc40h6Iz91FxXJUD"
                            width="100%"
                            height="100%"
